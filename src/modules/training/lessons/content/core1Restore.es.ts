...
export const core1RestoreEs: TrainingLessonContent = {
  ...
  briefHeading: 'La Restauración en breve',
  briefBody:
  ...
  scriptures: [
    {
      ref: 'José Smith—Historia 1:17',
      text: 'Vi a dos Personajes, cuyo fulgor y gloria desafían toda descripción...',
    },
    {
      ref: 'Doctrina y Convenios 1:30',
      text: 'Y también aquellos a quienes se dieron mandamientos de ir adelante y establecer la causa de Sión',
    },
    {
      ref: 'Artículos de Fe 1:6',
      text: 'Creemos en la misma organización que existió en la Iglesia Primitiva...',
    },
  ],
