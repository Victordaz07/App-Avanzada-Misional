...
export const core3PriesthoodEs: TrainingLessonSpecific = {
  intro:
  ...
  scriptures: [
    ...
    {
      ref: 'DyC 20:38–60',
      text: 'Deberes de oficios: bautismo, Santa Cena, bendiciones y ordenanzas.',
    },
    {
      ref: 'DyC 107:1–20',
      text: 'There are, in the church, two priesthoods...',
    },
    {
      ref: 'Mateo 16:19',
      text: 'Y a ti te daré las llaves del reino de los cielos...',
    },
    {
      ref: 'Hebreos 5:4',
      text: 'Y nadie toma para sí esta honra, sino el que es llamado de Dios...',
    },
  ],
  didYouKnow: [
