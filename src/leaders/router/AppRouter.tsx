...
const AppRouter: React.FC = () => {
  ...
  return (
    <Routes>
      ...
      {/* Ward setup (requires auth + role, but not ward). Tabs: ver LeadersRouteGroup en SPA unificada. */}
      <Route
        path="/ward-setup"
        element={
          <ProtectedRoute>
      ...
      {/* Protected routes - Leadership Callings module (requires Auth + Role + Ward) */}
      <Route
        path="/*"
        element={
          <ProtectedRoute>
